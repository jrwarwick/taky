...
"""
User friendly questionaire should result in taky.conf compliant file.
"""
...
try:
    ...
    warning_message = "Warning: that username does NOT yet exist. "
...
# Summary:
# TODO: review all of these, really should track closer to conf file strings
taky_configuration = {
        'hostname':             hostname,
